...
function displayCanvasText(text) {
	chartContext.font = "45px Arial";
	chartContext.textAlign = "center";
	chartContext.fillText(text, canvas.width/2 + 50, canvas.height/2);
}
...
function showCorrect() {
	...
	appendMessage("Here's the actual relationship according to data. As GDP increases, life expectancy increases with diminishing returns.", "warning");
